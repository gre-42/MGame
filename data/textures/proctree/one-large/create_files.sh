...
for i in {0..3}; do
    for steps in 10; do
        ...
        mSeed=$seed mTreeSteps=$steps mTrunkLength=1.5 mLevels=5 mTwigScale=0.25 mDropAmount=0 mMaxRadius=0.12 /home/kl/MySrc/mlib/URelease/Apps/Proc_Tree/proc_tree
